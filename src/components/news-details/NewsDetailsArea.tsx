                                ...
                                <div className="row tag-share-wrap">
                                    <div className="col-lg-8 col-12">
                                        ...
                                        <div className="tagcloud">                                   
                                            <Link to="/news-details">Course</Link>
                                            <Link to="/news-details">Education</Link>
                                            <Link to="/news-details">Training</Link>
                                        </div>
                                    </div>
                            ...
                            <div className="main-sidebar sticky-style">
                                ...
                                <div className="single-sidebar-widget">
                                    ...
                                    <div className="popular-posts">
                                        ...
                                        <div className="single-post-item">
                                            ...
                                            <div className="post-content">
                                                <h5><Link to="/news-details">Social Media Marketing MASTERY( A-Z ) Journey</Link></h5>
                                                <div className="post-date">
                                        ...
                                        <div className="single-post-item">
                                            ...
                                            <div className="post-content">
                                                <h5><Link to="/news-details">Branding: How to Brand Yourself and Your</Link></h5>
                                                <div className="post-date">
                                ...
                                <div className="single-sidebar-widget">
                                    ...
                                    <div className="widget_categories">
                                        <ul>
                                            <li><Link to="/news">Branding <span>23</span></Link></li>
                                            <li><Link to="/news">Digital Marketing <span>24</span></Link></li>
                                            <li><Link to="/news">Science <span>11</span></Link></li>
                                            <li><Link to="/news">Social Media <span>05</span></Link></li>
                                            <li><Link to="/news">Uncategorized <span>06</span></Link></li>
                                            <li><Link to="/news">Web Development <span>10</span></Link></li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="single-sidebar-widget">
                                ...
                                <div className="single-sidebar-widget">
                                    ...
                                    <div className="tagcloud">
                                        ...
                                        <Link to="/news-details">Consulting</Link>
                                        <Link to="/news-details">Education</Link>
                                        <Link to="/news-details">Immigration</Link>
                                        <Link to="/news-details">Course</Link>
                                        <Link to="/news-details">Learn</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
