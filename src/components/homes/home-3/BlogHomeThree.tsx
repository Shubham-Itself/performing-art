                    ...
                    <div className="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                        <div className="news-left-items">
                            ...
                            <div className="news-content">
                                ...
                                <h3>
                                    <Link to="/news-details">Balancing to Academics the Campus Student's Success Stories from Our Graduates</Link>
                                </h3>
                        ...
                        <div className="news-right-items">
                            <div className="news-right-box wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div className="content">
                                    ...
                                    <h5>
                                        <Link to="/news-details">Power Lifelong the Learning
                            ...
                            <div className="news-right-box wow fadeInUp" data-wow-delay=".5s">
                                ...
                                <div className="content">
                                    ...
                                    <h5>
                                        <Link to="/news-details">Navigating Your to College Journey Tips for New</Link>
                                    </h5>
                                    <Link to="/news-details" className="link-btn">Read More <i className="far fa-chevron-double-right"></i></Link>
                                </div>
                            </div>
                            <div className="news-right-box wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div className="content">
                                    ...
                                    <h5>
                                        <Link to="/news-details">Balancing to Academics the
